...
class PaletteRasterImageTest {
    private final Color color = Color.RED;
    private final int width = 10;
    private final int height = 10;
    public RasterImageTest testBasic = new RasterImageTest(width, height, color, PaletteRasterImage.class);

    public PaletteRasterImageTest() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
    }
